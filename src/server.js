...
// Static files for frontend (login.html and Menged-Fleet-Dashboard.html)
...
app.listen(PORT, () => {
  // eslint-disable-next-line no-console
  console.log(`Menged Fleet Operations is running locally at:`);
  console.log(`➜ App URL:  http://localhost:${PORT}/login.html`);
